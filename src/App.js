  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Welcome to HomeBuyingDAO</h1>
...
if (hasClaimedNFT) {
  return (
    <div className="member-page">
      <h1>🏡 HomeBuying DAO Member Page</h1>
...
return (
  <div className="mint-nft">
    <h1>Mint Your Free 🏡HomeBuying DAO Membership NFT</h1>
    <button
      disabled={isClaiming}
      onClick={() => {
        setIsClaiming(true);
        ...
        bundleDropModule
          ...
          .finally(() => {
            ...
            console.log(
              `💰 Successfully minted! See it on OpenSea: https://testnets.opensea.io/assets/${bundleDropModule.address}/0`
            );
          });
      }}
    >
